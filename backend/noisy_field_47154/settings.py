"""
Django settings for noisy_field_47154 project.
...
ROOT_URLCONF = 'noisy_field_47154.urls'
...
WSGI_APPLICATION = 'noisy_field_47154.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_field_47154 API",
    "DESCRIPTION": "API documentation for noisy_field_47154 App",
    "VERSION": "v1",
}
